...
{
    public class RepeatSubmitInnerController : ApiController
    {
        private readonly ILog _logInfo;
        private readonly IRepeatSubmitService _repeatSubmitService;

        public RepeatSubmitInnerController(IRepeatSubmitService repeatSubmitService)
        {
        ...
        [EnableCommonThrottling(PerSecond = 2, PerMinute = 10, PerHour = 100)]
