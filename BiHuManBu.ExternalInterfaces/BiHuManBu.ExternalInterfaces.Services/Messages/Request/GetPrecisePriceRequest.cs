...
{
    public class GetPrecisePriceRequest : BaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// 是否展示其他车辆信息 包含年款、车型别名 0否1展示
        /// </summary>
        public int ShowVehicleInfoOther { get; set; }
        ...
        public int ShowTaiBaoFen { get; set; }
        ...
        /// 对外接口显示不计免总额
        /// </summary>
        public int ShowBuJiMianFuJia { get; set; }
        /// <summary>
        /// 是否展示商业、交强险到期时间
        /// </summary>
        public int ShowEndDate { get; set; }
        /// <summary>
        /// 是否显示太平洋最小折扣率 20190725by gpj
        /// </summary>
        public int ShowActualDiscounts { get; set; }
        /// <summary>
        /// 是否展示车属性（是否贷款、过户时间） 0不展示   >0展示
        /// </summary>
        public int ShowCarProperties { get; set; }
        /// <summary>
        /// 是否显示驾意险 0不展示1展示
        /// </summary>
        public int ShowJiaYi { get; set; }
    }
}
