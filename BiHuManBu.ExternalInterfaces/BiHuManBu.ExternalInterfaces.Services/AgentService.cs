...
namespace BiHuManBu.ExternalInterfaces.Services
{
    public class AgentService : CommonBehaviorService, IAgentService
    {
        ...
        private IAgentRateRepository _rateRepository;
        private IAgentSpecialRateRepository _specialRateRepository;
        ...
        /// <param name="pairs"></param>
        /// <returns></returns>
        public GetAgentResponse GetAgentByOpenId(GetByOpenIdRequest request, IEnumerable<KeyValuePair<string, string>> pairs)
        {
            var response = new GetAgentResponse();
        ...
        public GetAgentResponse GetAgentByOpenIdOld(GetByOpenIdRequest request, IEnumerable<KeyValuePair<string, string>> pairs)
        {
            var response = new GetAgentResponse();
            var agent = _agentRepository.GetAgentByTopParentAgent(request.OpenId, request.TopParentAgent);
            if (agent != null)
        ...
        {
            List<bx_agent> agentlist = _agentRepository.GetAgentExpireList(status);
            return agentlist;
        }
    }
