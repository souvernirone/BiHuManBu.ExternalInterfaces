...
{
    public class SetPrecisePriceItemService : ISetPrecisePriceItemService
    {
        ...
        public SetPrecisePriceItemService(IAgentConfigRepository agentConfigService, IQuoteResultRepository quoteResultRepository, 
            IPictureRepository pictureRepository, ISaveQuoteRepository saveQuoteRepository, ISubmitInfoRepository submitInfoRepository, 
            IHebaoDianweiRepository hebaoDianweiRepository, ISetPrecisePriceItem setPrecisePriceItem, IYwxdetailRepository ywxdetailRepository)
        {
