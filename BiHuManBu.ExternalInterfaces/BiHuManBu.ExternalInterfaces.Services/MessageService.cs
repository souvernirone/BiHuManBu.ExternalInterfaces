...
namespace BiHuManBu.ExternalInterfaces.Services
{
    public class MessageService : CommonBehaviorService, IMessageService
    {
        ...
        public MessageService(IMessageRepository messageRepository, IAgentRepository agentRepository, INoticexbRepository noticexbRepository, IUserInfoRepository userInfoRepository, IConsumerReviewRepository consumerReviewRepository, IUserinfoRenewalInfoRepository userinfoRenewalInfoRepository, ICacheHelper cacheHelper)
